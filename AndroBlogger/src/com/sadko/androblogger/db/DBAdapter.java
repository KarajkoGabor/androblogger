...
public class DBAdapter {
	...
	private static final String DATABASE_NAME = "androblogger";
    ...
    public long createSetting(String login, String password) {
        ...
        Log.i(TAG,"Login: '"+login+"', password: '"+password+"' successfuly inserted");
    ...
    public Cursor fetchSettindById(long rowId) throws SQLException {
        Cursor mCursor =mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                        KEY_LOGIN, KEY_PASSWORD}, KEY_ROWID + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
